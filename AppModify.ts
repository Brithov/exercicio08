...
import { Banco, Conta, Poupanca, ContaImposto, AplicacaoError, ContaInexistenteError, SaldoInsuficienteError, ValorInvalidoError, PoupancaInvalidaError} from "./BancoModify";
...
function exibirConta(numero: String): void {
  let conta: Conta = b.consultar(numero);
  console.log(`Conta ${b.consultar(numero).numero} - ${b.consultar(numero).saldo}`);
